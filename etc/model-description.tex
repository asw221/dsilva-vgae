...
backpropagation: the randomness is isolated in ε, which has no learned
parameters. The result is a matrix $Z \in \mathbb{R}^{N \times d}$ of
...
loss\_gamma ($\gamma$)
& Weight on the KL divergence term. Default: 1.0. Increasing γ
